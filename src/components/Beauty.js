        ...
        <div className='py-2'>
            ...
            <div className=''>
                ...
                <div className='rounded-xl relative grid md:grid-cols-5 px-10'>
                     ...
                     <div><img className='h-[260px] w-[250px] pt-6 shadow-lg hover:scale-105 duration-300' src='https://images.pexels.com/photos/10415083/pexels-photo-10415083.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='Lip Care' /><h1 className='font-bold text-2xl text-white pl-20'>Lip Care</h1></div>
