        ...
        <div className='py-2'>
            ...
            <div className=''>
                ...
                <div className='rounded-xl relative grid md:grid-cols-5 px-10'>
                     ...
                     <div><img className='h-[260px] w-[250px] pt-6 shadow-lg hover:scale-105 duration-300' src='https://images.pexels.com/photos/45057/pexels-photo-45057.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='Gloves' /><h1 className='font-bold text-2xl text-white pl-20'>Gloves</h1></div>
                     <div><img className='h-[260px] w-[250px] pt-6 shadow-lg hover:scale-105 duration-300' src='https://images.pexels.com/photos/7222851/pexels-photo-7222851.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='Long Coats' /><h1 className='font-bold text-2xl text-white pl-16'>Long Coats</h1></div>
                     ...
                     <div><img className='h-[260px] w-[250px] pt-6 shadow-lg hover:scale-105 duration-300' src='https://images.pexels.com/photos/13946211/pexels-photo-13946211.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='Track Pants' /><h1 className='font-bold text-2xl text-white pl-16'>Track Pants</h1></div>
