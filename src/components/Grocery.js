    ...
    <div>
        <div>
            <img className='absolute w-full h-[80px] py-1 object-cover  mix-blend-overlay opacity-80' src='https://images.pexels.com/photos/6044253/pexels-photo-6044253.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='/' />
               <p className='text-white font-bold text-5xl justify-center items-center pl-[450px] pt-3'>Everyday Food Essentials</p>
        </div>
        <div>
            <img className='absolute w-full h-[850px] py-5 object-cover  mix-blend-overlay opacity-80' src='https://images.pexels.com/photos/7232493/pexels-photo-7232493.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='/' />
        ...
        <div>
            <img className='absolute w-full h-[80px] py-1 object-cover  mix-blend-overlay opacity-80' src='https://images.pexels.com/photos/6044253/pexels-photo-6044253.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='/' />
               <p className='text-white font-bold text-5xl justify-center items-center pl-[600px] pt-3'>Personal Care</p>
        </div>
        <div>
        <img className='absolute w-full h-[450px] py-5 object-cover  mix-blend-overlay opacity-80' src='https://images.pexels.com/photos/7232493/pexels-photo-7232493.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='/' />
        <div className='rounded-xl relative grid md:grid-cols-3 px-10'>
            <div className='pt-4 relative'>
                 <div className='absolute    text-white'>
        ...
        <div>
            <img className='absolute w-full h-[80px] py-1 object-cover  mix-blend-overlay opacity-80' src='https://images.pexels.com/photos/6044253/pexels-photo-6044253.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='/' />
               <p className='text-white font-bold text-5xl justify-center items-center pl-[600px] pt-3'>Home and Kitchen</p>
        </div>
        <div>
        <img className='absolute w-full h-[450px] py-5 object-cover  mix-blend-overlay opacity-80' src='https://images.pexels.com/photos/7232493/pexels-photo-7232493.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='/' />
        <div className='rounded-xl relative grid md:grid-cols-3 px-10'>
