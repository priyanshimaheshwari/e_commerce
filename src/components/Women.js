        ...
        <div className='py-4'>
            ...
            <div className=''>
                ...
                <div className='rounded-xl relative grid md:grid-cols-5 px-10'>
                     ...
                     <div><img className='h-[260px] w-[250px] pt-6' src='https://images.pexels.com/photos/2820793/pexels-photo-2820793.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='/' /><h1 className='font-bold text-2xl text-white pl-20 shadow-lg hover:scale-105 duration-300'>Skirts</h1></div>
                     <div><img className='h-[260px] w-[250px] pt-6' src='https://images.pexels.com/photos/8819340/pexels-photo-8819340.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='/' /><h1 className='font-bold text-2xl text-white pl-20 shadow-lg hover:scale-105 duration-300'>Ethnic</h1></div>
