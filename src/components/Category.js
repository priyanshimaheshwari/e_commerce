...
const Category = () => {
  return (
    <div>
        ...
        <div><img className='h-[150px] w-[150px] rounded-full' src='https://images.pexels.com/photos/47261/pexels-photo-47261.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt='/' /><select className='relative px-6'><option>Mobiles</option></select></div>
